...
if(isset($_POST['btnaprod']) && ($_POST['btnaprod'] != "") && isset($_POST['txtsku']) && ($_POST['txtsku'] != "") && isset($_POST['txtname']) && ($_POST['txtname'] != "") && isset($_POST['lstprodmcat']) && ($_POST['lstprodmcat'] != "") && isset($_POST['lstprodcat']) && ($_POST['lstprodcat'] != "") && isset($_POST['txtprior']) && ($_POST['txtprior'] != ""))
{
  ...
  if($cntrec < 1)
  {
    ...
    $iqryprod_mst	="INSERT into prod_mst(prodm_sku, prodm_hsncde, prodm_name, prodm_prodmcatid, prodm_prodcatid, prodm_prodscatid, prodm_prodbrnd, prodm_prodmnfcr, prodm_prodmnfcr_disp, prodm_distby, prodm_orgncntry, prodm_vrnttyp, prodm_prodtyp, prodm_dsc, prodm_st, prodm_sdsc, prodm_sky, prodm_sotl, prodm_sodsc, prodm_sttle, prodm_stdsc, prodm_sts, prodm_rnk, prodm_crton, prodm_crtby) values ('$sku','$hsncde','$name','$prodmcat','$prodcat', '$prodscat','$prodbrnd', '$prodmnfcr', '$mfdispl', '$distby','$country', '$vrnttyp', '$typ','$desc','$seottl','$seodesc','$seokywrd','$seoh1_tle','$seoh1_desc','$seoh2_tle','$seoh2_desc','$sts','$prty','$dt','$ses_admin')";
