...
//								echo $sqrycrtord_mst; exit;
 ...
 //echo "Mobile".$bphno;
		...
		/*	 $msg = "Thank you for placing an Order for $db_ordqty items for $db_ordamt Your order reference id is $ordcode,www.Liamsons.com,+0 70934 60111";	
        $msg = urlencode($msg);
...
experience on www.Liamsons.com by logging in your account. 
							  ...
							  <tr>
								<td><table width='100%' cellpadding='5' cellspacing='0' border='1' bordercolor='#dfdfdf' style='border:1px solid #dfdfdf'>
									<tr>
									  ...
									  /*if($nmstrws == 1){
										 $msgbody.=" <td  valign='middle'><p style='color:#d31b12'>TAX1</p></td>
    									  <td  valign='middle'><p style='color:#d31b12'>TAX2</p></td>"; 
										  }else{
		  							$msgbody.=" <td  valign='middle'><p style='color:#d31b12'>TAX</p></td>";
											  }*/
	 						$msgbody.="<td align='right' valign='middle'><p style='color:#d31b12'>Total Price($)<i class='fas fa-dollar-sign'></i></p>                                </td>
									</tr>";
                                  ...
                                  where crtordd_crtordm_id=$orderid group by crtordd_id  
									...
									//echo $rowspo_mst['crtordd_shpprc'];
															$msgbody.="<tr>
...
/*
				     ...
				     $cgst =  number_format($cgsttax,2,'.',',');

				    $sgst =  number_format( $sgsttax,2,'.',',');

					   $prdwoustgst  = $db_prc-($cgst+$sgst);
					    ...
					    $gstper = ($gstval/2);
														...
														/*if($nmstrws == 1){
											$msgbody.="<td valign='right'>$cgst<br>$cgstval</td>
														<td valign='right'>$sgst<br>$sgstval</td>";		
															}else{
										$msgbody.="<td valign='right'>$gst<br>$igstper</td>";		
               ...
               $msgbody.="<td align='right' valign='middle'>".number_format($totlprdprc,2,'.',',')."</td>
							...
							<table width='605' border='0' align='center' cellpadding='0' cellspacing='0'>
							  <tr>
								...
								<td><p>For suggestions / support please feel free to email us at <a href='mailto:$u_prjct_url1s' style='color:#d31b12; text-decoration:none'>$u_prjct_url1s</a>.</p>
								  <p>Sincerely, <br>
									...
									<a href='http://".$u_prjct_mnurl."'>Liamsons Pearls &amp; Jewellers<br>
 ...
 <tr>
<td><a href='https://".$u_prjct_mnurl."/home' ><img src='https://www.Liamsons.com/images/Liamsons-logo.png' alt='$usr_cmpny' hspace='10' vspace='15' width='200'></a></td>

<td align='right' width='50%'> <a href='https://www.Liamsons.com/list-order' target='_blank' style='color:#e99005; margin-right:10px;'>Your Orders</a> | <a href='https://www.Liamsons.com/' target='_blank' style='color:#e99005; margin-left:10px;'>Liamsons.com</a><br>
