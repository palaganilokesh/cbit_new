...
<head>
	...
	<title>
		<?php if (isset($page_seo_title) && !empty($page_seo_title)) echo $page_seo_title; ?>
	</title>
						...
						<div class="">
							<div
								...
								<div class="search-box">
									<a href="#" data-bs-toggle="modal" data-bs-target="#searchPopupModal"><i
			...
			<div id="header-wrap" class="mega-menu-extarnal">
				<div class="container">
					<div class="header-row">
						...
						<!-- Primary Navigation
                    ============================================= -->
							<?php		$sqryprodcat_mst_nav = "SELECT prodmnlnksm_id,prodmnlnksm_name,prodcatm_prodmnlnksm_id,prodcatm_id,prodcatm_name,prodcatm_prty,prodcatm_typ,prodmnlnksm_typ,prodmnlnksm_dsplytyp from prodcat_mst
