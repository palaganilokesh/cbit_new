...
$sqrybrnd_mst = "select
abtusm_id,abtusm_name,abtusm_desc,abtusm_imgnm,
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-12">
                        <div class="row mb-2 mt-2">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="txtlnk" id="txtlnk" class="form-control" size="4" value="<?php echo $rowsbrnd_mst['abtusm_lnk']; ?>">
                    ...
                    <div class="col-md-12">
                        <div class="row mb-2 mt-2">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="txtprior" id="txtprior" class="form-control" size="4" maxlength="3" value="<?php echo $rowsbrnd_mst['abtusm_prty']; ?>">
                        ...
                        <div class="row mb-2 mt-2">
                            ...
                            <div class="col-sm-9">
                                <select name="lststs" id="lststs" class="form-control">
                                    <option value="a" <?php if ($rowsbrnd_mst['abtusm_sts'] == 'a') echo 'selected'; ?>>Active</option>
                                    <option value="i" <?php if ($rowsbrnd_mst['abtusm_sts'] == 'i') echo 'selected'; ?>>Inactive</option>
                                </select>
                            </div>
                        </div>
                    </div>
