...
<section class="content">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">View Recruiters/Recognitions</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">View Recruiters/Recognitions</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?php
                                $imgnm = $rowsprodscat_mst['brndm_img'];
                        ...
                        <div class="form-group row">
                            <label for="txtname" class="col-sm-2 col-md-2 col-form-label">Type</label>
                            <div class="col-sm-8">
                                <?php echo funcDispBrndtyp($rowsprodscat_mst['brndm_typ']); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?php echo $rowsprodscat_mst['brndm_lnk']; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?php echo $rowsprodscat_mst['brndm_prty']; ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="txtname" class="col-sm-2 col-md-2 col-form-label">Status</label>
                            <div class="col-sm-8">
                                <?php echo $rowsprodscat_mst['brndm_sts']; ?>
                            </div>
                        </div>
                        <p class="text-center">
