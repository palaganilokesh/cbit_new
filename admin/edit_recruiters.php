...
if (
    ...
    include_once "../database/uqry_rcrt_mst.php";
}
if (
...
$sqrybrnd_mst = "select
					   ...
					   brndm_zmimg,brndm_sts,brndm_prty,brndm_seotitle,brndm_seodesc,
					   brndm_seokywrd,brndm_seohonetitle,brndm_seohonedesc,brndm_seohtwotitle,
					   brndm_seohtwodesc,brndm_typ,brndm_lnk
	               from
				       brnd_mst
                   where
				       brndm_id=$id";
...
if ($cntbrnd_mst > 0) {
    ...
    header('Location: view_all_recruiters.php');
    exit;
}
...
<section class="content">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit Recruiters/Recognitions</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Edit Recruiters/Recognitions</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="row mb-2 mt-2">
                            ...
                            <div class="col-sm-9">
                                <input name="txtname" type="text" id="txtname" size="45" maxlength="40" onBlur="funcChkDupName()" class="form-control" value="<?php echo $rowsbrnd_mst['brndm_name']; ?>">
                    ...
                    <div class="col-md-12">
                        <div class="row mb-2 mt-2">
                            ...
                            <div class="col-sm-9">
                                <textarea name="txtdesc" cols="60" rows="3" id="txtdesc" class="form-control"><?php echo $rowsbrnd_mst['brndm_desc']; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="row mb-2 mt-2">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="txtprior" id="txtprior" class="form-control" size="4" maxlength="3" value="<?php echo $rowsbrnd_mst['brndm_prty']; ?>">
                        ...
                        <div class="row mb-2 mt-2">
                            ...
                            <div class="col-sm-9">
                                <select name="lststs" id="lststs" class="form-control">
                                    <option value="a" <?php if ($rowsbrnd_mst['brndm_sts'] == 'a') echo 'selected'; ?>>Active</option>
                                    <option value="i" <?php if ($rowsbrnd_mst['brndm_sts'] == 'i') echo 'selected'; ?>>Inactive</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <p class="text-center">
                        <input type="Submit" class="btn btn-primary btn-cst" name="btnedtbrnd" id="btnedtbrnd" value="Submit">
                        &nbsp;&nbsp;&nbsp;
