...
nwsm_id,nwsm_name,nwsm_sts,nwsm_desc,nwsm_prty,nwsm_typ,nwsm_lnk,
...
<section class="content">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">View Updates / Notifications</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">View Updates / Notifications</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?php echo $rowsprodscat_mst['nwsm_name']; ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="txtname" class="col-sm-2 col-md-2 col-form-label">Date</label>
                            <div class="col-sm-8">
                                <?php echo $rowsprodscat_mst['nwsm_dt']; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?php echo $rowsprodscat_mst['nwsm_desc']; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?php echo $rowsprodscat_mst['nwsm_lnk']; ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="txtname" class="col-sm-2 col-md-2 col-form-label">Type</label>
                            <div class="col-sm-8">
                                <?php
                                if ($rowsprodscat_mst['nwsm_typ'] == 1) {
                                    echo "Results Updates";
                                } else if ($rowsprodscat_mst['nwsm_typ'] == 2) {
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?php echo $rowsprodscat_mst['nwsm_prty']; ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="txtname" class="col-sm-2 col-md-2 col-form-label">Status</label>
                            <div class="col-sm-8">
                                <?php echo $rowsprodscat_mst['nwsm_sts']; ?>
                            </div>
                        </div>
                        <p class="text-center">
