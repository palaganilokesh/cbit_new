...
(function($) {
    ...
    SEMICOLON.header = {
        ...
        initialize: function() {
            ...
            $('.menu-item:not(.mega-menu-title):has(.sub-menu-container):not(:has(.sub-menu-trigger))').append('<button class="sub-menu-trigger icon-chevron-right"><i class="fa-solid fa-chevron-right"></i></button>');
